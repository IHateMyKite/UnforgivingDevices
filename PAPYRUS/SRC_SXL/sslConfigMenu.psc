...
function RebuildClean()
	...
	AddTextOptionST("VoiceCount", "Voices", VoiceSlots.Slotted+" / "+VoiceSlots.GetNumAliases(), OPTION_FLAG_DISABLED)
	AddTextOptionST("ExpressionCount", "Expressions", ExpressionSlots.Slotted+" / "+ExpressionSlots.GetNumAliases(), OPTION_FLAG_DISABLED)
