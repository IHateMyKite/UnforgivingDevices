Scriptname UDCustomHeavyBondageWidget1 extends SKI_WidgetBase  
...
float    _width            = 292.8
float    _height            = 25.2
int        _primaryColor    = 0x0000ff ;BLUE
int        _secondaryColor    = 0x00ff00 ;GREEN
int        _flashColor        = 0xff0000 ;RED
        ...
        if a_val >= 0 && a_val <= 2
            ...
            if (Ready) 
                if _positionY == 0 ;down
                    Y = UI.getFloat("HUD Menu", "_root.HUDMovieBaseInstance.BottomRightRefY") - 1.05*Height
                elseif _positionY == 1 ;less down
                    Y = UI.getFloat("HUD Menu", "_root.HUDMovieBaseInstance.BottomRightRefY") - 2.0*Height
                elseif _positionY == 2 ;top
                    Y = UI.getFloat("HUD Menu", "_root.HUDMovieBaseInstance.TopLeftRefY") + 2.5*Height; - 2.05*Height
                endif
            endIf
        endif
    endFunction
...
Function updateSize()
    ...
    debug.trace("[UD]: Widget width: " + Width + "; Height: " + Height)
EndFunction
