...
Event OnUpdate()
    if target.isSwimming()
        if !SwimmingScript.startedSwimming
            ...
            SwimmingScript.UDMain.UDWC.ShowNotification("You are having hard time swimming with your hands tied!")
        endif
        ...
        if target.getAV("Stamina") <= 1.0 && !SwimmingScript.drowning
            ...
            SwimmingScript.UDMain.UDWC.ShowNotification("You are drowning!")
        endif
