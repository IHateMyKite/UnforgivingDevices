;/  File: UD_ModOutcome_EquipDevice
    ...
    Example:
        1,FIRST     One device will be summoned. The first suitable device from the list in Form3 will be selected, 
                    starting from the top one.
        5,F,R       Five devices ill be summoned. First the matching devices will be selected from the list in Form3, and 
