Scriptname UD_controllablePlug_RenderScript extends UD_CustomPlug_RenderScript  
...
bool Function proccesSpecialMenu(int msgChoice)
    ...
    if msgChoice == 1
        turnOnPlug(UDCDmain.controllablePlugVibMessage.show() + 1,UDCDmain.controllablePlugModMessage.show())
        res = True
    elseif msgChoice == 2
