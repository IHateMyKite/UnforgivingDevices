...
Function patchFinish(UD_CustomDevice_RenderScript akDevice,int aiControlVar = 0x0F,Float afMult = 1.0, Int aiType = 0)
    ...
    if loc_random > 75
        if loc_random < 90
            akDevice.UD_WeaponHitResist = akDevice.UD_WeaponHitResist + Utility.randomFloat(0.25,0.75)
        else
            akDevice.UD_WeaponHitResist = akDevice.UD_WeaponHitResist - Utility.randomFloat(0.25,0.75)
        endif
    endif
    ...
    akDevice.UD_Level = Round(Utility.randomFloat(fRange(loc_level*0.75,1.0,100.0),fRange(loc_level*1.25,1.0,100.0)))
...
Function GenerateLocks(UD_CustomDevice_RenderScript akDevice, Int aiType, Int aiDifficulty)
    ...
    if !akDevice.HaveLocks()
        ...
        elseif aiType == 2 ;nipple piercing
            Int[] loc_lockShields = UDCDMain.DistributeLockShields(2,Utility.randomInt(UD_MinLocks,UD_MaxLocks))
        ...
        elseif aiType == 10 ;Suit
            Int[] loc_lockShields = UDCDMain.DistributeLockShields(5,Utility.randomInt(UD_MinLocks,UD_MaxLocks))
        ...
        elseif aiType == 13 ;Harness
            Int[] loc_lockShields = UDCDMain.DistributeLockShields(3,Utility.randomInt(UD_MinLocks,UD_MaxLocks))
